export default function TermsOfServicePage() {
  ...
  return (
    <div style={styles.body}>
      ...
      <p style={styles.p}>Last updated: March 18, 2024</p>
      <p style={styles.p}>Please read these terms and conditions carefully before using Our Service.</p>
      <h2 style={styles.h2}>Interpretation and Definitions</h2>
      <h3 style={styles.h3}>Interpretation</h3>
      <p style={styles.p}>The words of which the initial letter is capitalized have meanings defined under the following conditions. The
      ...
      <p style={styles.p}>For the purposes of these Terms and Conditions:</p>
      <ul>
        <li>
          <p style={styles.p}><strong style={styles.strong}>Affiliate</strong> means an entity that controls, is controlled by or is under common control with
        ...
        <li>
          <p style={styles.p}><strong style={styles.strong}>Country</strong> refers to: Gujarat, India</p>
        </li>
        <li>
          <p style={styles.p}><strong style={styles.strong}>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SocialSync.
          </p>
        </li>
        <li>
          <p style={styles.p}><strong style={styles.strong}>Device</strong> means any device that can access the Service such as a computer, a cellphone or a
            digital tablet.</p>
        </li>
        <li>
          <p style={styles.p}><strong style={styles.strong}>Service</strong> refers to the Website.</p>
        </li>
        <li>
          <p style={styles.p}><strong style={styles.strong}>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions
            that form the entire agreement between You and the Company regarding the use of the Service. This Terms and
            Conditions agreement has been created with the help of the <a style={styles.a}
              href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank">Terms and Conditions
              Generator</a>.</p>
        </li>
        <li>
          <p style={styles.p}><strong style={styles.strong}>Third-party Social Media Service</strong> means any services or content (including data,
        ...
        <li>
          <p style={styles.p}><strong style={styles.strong}>Website</strong> refers to SocialSync, accessible from <a style={styles.a}
            href="https://social-sync-frontend.vercel.app" rel="external nofollow noopener"
            target="_blank">https://social-sync-frontend.vercel.app</a></p>
        </li>
        <li>
          <p style={styles.p}><strong style={styles.strong}>You</strong> means the individual accessing or using the Service, or the company, or other legal
      ...
      <p style={styles.p}>These are the Terms and Conditions governing the use of this Service and the agreement that operates between
      ...
      <p style={styles.p}>Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and
        Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the
        Service.</p>
      <p style={styles.p}>By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any
        part of these Terms and Conditions then You may not access the Service.</p>
      <p style={styles.p}>You represent that you are over the age of 18. The Company does not permit those under 18 to use the
        Service.</p>
      <p style={styles.p}>Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy
      ...
      <p style={styles.p}>Our Service may contain links to third-party web sites or services that are not owned or controlled by the
        Company.</p>
      <p style={styles.p}>The Company has no control over, and assumes no responsibility for, the content, privacy policies, or practices
      ...
      <p style={styles.p}>We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or
        services that You visit.</p>
      <h2 style={styles.h2}>Termination</h2>
      <p style={styles.p}>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason
        whatsoever, including without limitation if You breach these Terms and Conditions.</p>
      <p style={styles.p}>Upon termination, Your right to use the Service will cease immediately.</p>
      <h2 style={styles.h2}>Limitation of Liability</h2>
      <p style={styles.p}>Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers
        ...
        Service.</p>
      <p style={styles.p}>To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for
      ...
      <p style={styles.p}>Some states do not allow the exclusion of implied warranties or limitation of liability for incidental or
      ...
      <h2 style={styles.h2}>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p style={styles.p}>The Service is provided to You &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; and with all faults and defects
        ...
        corrected.</p>
      <p style={styles.p}>Without limiting the foregoing, neither the Company nor any of the company&apos;s provider makes any representation
        ...
        Company are free of viruses, scripts, trojan horses, worms, malware, time bombs or other harmful components.</p>
      <p style={styles.p}>Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable
      ...
      <p style={styles.p}>The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the
      ...
      <p style={styles.p}>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally
        by contacting the Company.</p>
      <h2 style={styles.h2}>For European Union (EU) Users</h2>
      <p style={styles.p}>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country
        in which You are resident.</p>
      <h2 style={styles.h2}>United States Legal Compliance</h2>
      <p style={styles.p}>You represent and warrant that (i) You are not located in a country that is subject to the United States
      ...
      <p style={styles.p}>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and
      ...
      <p style={styles.p}>Except as provided herein, the failure to exercise a right or to require performance of an obligation under
      ...
      <p style={styles.p}>These Terms and Conditions may have been translated if We have made them available to You on our Service.
        You agree that the original English text shall prevail in the case of a dispute.</p>
      <h2 style={styles.h2}>Changes to These Terms and Conditions</h2>
      <p style={styles.p}>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is
      ...
      <p style={styles.p}>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the
        revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the
        Service.</p>
      <h2 style={styles.h2}>Contact Us</h2>
      <p style={styles.p}>If you have any questions about these Terms and Conditions, You can contact us:</p>
      <ul>
        <li>By email: faiz@marketingcompany.tech</li>
      </ul>
    </div>
  );
}
